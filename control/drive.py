...
from hardware.motor_driver_left import set_motor_current as set_motor_current_left, send_watchdog_check as send_watchdog_check_left
from hardware.motor_driver_right import set_motor_current as set_motor_current_right, send_watchdog_check as send_watchdog_check_right
...
async def send_watchdogs_checks():
    await send_watchdog_check_left()
    await send_watchdog_check_right()
